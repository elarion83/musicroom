...
const PlayerButtons = ({room,playerControlsShown,isSpotifyPlayed,roomPlayedActuallyPlayed, playerRef,playingLastInListInComp, localVolume,playerIdPlayed,roomIsPlaying, setLocalVolume,setIsPlaying,setIdPlaying, setLayoutdisplay,isLayoutFullScreen,layoutDisplay, goToSecond}) => {
    ...
    return(
        <>
            ...
            <>
                ...
                {!isSpotifyPlayed && <IconButton onClick={e => (room.mediaActuallyPlayingAlreadyPlayedData.playedSeconds > 10) ? goToSecond(playedSeconds(playerRef) - 10) : ''}>
                ...
                {!isSpotifyPlayed && <IconButton onClick={e => goToSecond(playedSeconds(playerRef) + 10)}>
