...
const PlayerButtons = ({room,playerControlsShown,playerType, roomPlayedActuallyPlayed, playerRef,playingLastInListInComp, localVolume,playerIdPlayed,roomIsPlaying, setLocalVolume,setIsPlaying,setIdPlaying, setLayoutdisplay,isLayoutFullScreen,layoutDisplay, goToSecond}) => {
    ...
    return(
        <>
            ...
            <>
                ...
                <IconButton onClick={e => (room.mediaActuallyPlayingAlreadyPlayedData.playedSeconds > 10) ? goToSecond(playedSeconds(playerRef, playerType) - 10) : ''}>
                ...
                <IconButton onClick={e => goToSecond(playedSeconds(playerRef, playerType) + 10)}>
