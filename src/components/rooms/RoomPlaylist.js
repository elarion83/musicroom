                    ...
                    return (
                        <Fade in={true} xs={12} sx={{ width:'100%', padding:0, margin:0}}>
                            <Grid item sx={{ width:'100%', padding:0,pl:2, margin:0}}> 
                                ...
                                <ListItemButton onClick={e => handleChangeIdActuallyPlaying(idx)} key={'playlist_'+idx} xs={12} sx={{ width:'100%', padding:0,pl:0,margin:0 }} selected={roomIdActuallyPlaying === idx}>
